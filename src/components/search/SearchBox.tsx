...
// import GoogleSearchBox from "src/components/search/GoogleSearchBox";
import GooglePredictionsBox from "src/components/search/GooglePredictionsBox";
...
const SearchBox = (props: SearchBoxProps) => {
  ...
  useEffect(() => {
    ...
    if (mapRefCur) {
      setMap(true);
      console.log("SearchBox:", mapRefCur);
    ...
    <div className="shadow-brand-shadow p-6">
      ...
      <div className="flex items-center">
        <div className="relative w-full h-9">
          ...
          /> */}
          {/* {isMap && <GoogleSearchBox />} */}
          {isMap && <GooglePredictionsBox />}
        </div>
